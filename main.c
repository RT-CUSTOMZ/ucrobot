...
#include <avr/io.h>			// Einbinden von Einstellungen/Definitionen/usw. fÃ¼r den Mikrocontroller
#include <avr/interrupt.h>
#include <util/delay.h>		// Delayfunktionen

//Globale Variablen
//Motoren
uint8_t Mr_Status = 0; //Bit 0 & 1: ZÃ¤hler Motor Rechts
uint8_t Ml_Status = 0; //Bit 0 & 1: ZÃ¤hler Motor Rechts
